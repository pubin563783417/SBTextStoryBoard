...
@class SBAsyncLayerDisplayTask;

NS_ASSUME_NONNULL_BEGIN

/**
 The SBAsyncLayer class is a subclass of CALayer used for render contents asynchronously.
 ...
 */
@interface SBAsyncLayer : CALayer
...
/**
 The SBAsyncLayer's delegate protocol. The delegate of the SBAsyncLayer (typically a UIView)
 must implements the method in this protocol.
 */
@protocol SBAsyncLayerDelegate <NSObject>
@required
...
/**
 A display task used by SBAsyncLayer to render the contents in background queue.
 */
@interface SBAsyncLayerDisplayTask : NSObject
